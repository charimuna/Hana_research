...
ax.set_ylabel(
    "Absence of Documented Recognition of\n Approaching Death (%)", 
    fontsize=10)
ax.set_ylim(0, 45)
...
# 左側のラベル（太字で明示）
ax.text(-0.6, y_row1, "Outcome, n", ha='right', va='top', fontsize=8, fontweight='bold', clip_on=False)
ax.text(-0.6, y_row2, "Total, n",    ha='right', va='top', fontsize=8, fontweight='bold', clip_on=False)
